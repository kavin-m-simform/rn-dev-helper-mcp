 ...
 */
server.registerTool("get_screen_list", {
 ...
 */
server.registerTool("get_navigation_map", {
 ...
 */
server.registerPrompt("create_new_screen", {
 ...
 */
server.registerPrompt("refactor_ui", {
 ...
 * Connect API prompt
 */
server.registerPrompt("connect_api", {
 ...
 * Screens resource
 */
server.registerResource("screens", "rn://screens", {
 ...
 * Components resource
 */
server.registerResource("components", "rn://components", {
 ...
 * Navigation resource
 */
server.registerResource("navigation", "rn://navigation", {
